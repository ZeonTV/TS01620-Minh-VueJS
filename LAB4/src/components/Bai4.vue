    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        <div class="card h-100"> 
          <img :src="items[0].image" class="card-img-top" alt="Hình ảnh" />
          <div class="card-body">
      ...
      <div class="col-sm-4">
        <div class="card h-100">
          <img :src="items[1].image" class="card-img-top" alt="Hình ảnh" />
          <div class="card-body">
      ...
      <div class="col-sm-4">
        <div class="card h-100">
          <img :src="items[2].image" class="card-img-top" alt="Hình ảnh" />
          <div class="card-body">
...
<script setup>
import img1 from '../assets/images/raucu1.jpg';
import img2 from '../assets/images/giavi2.jpg';
import img3 from '../assets/images/cacloaidau1.jpg';
